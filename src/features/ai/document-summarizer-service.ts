/**
 * @module  ai
 * @feature document-summarizer-service
 * @branch  feat/ai-document-summarizer-service
 */
...
export interface CreateDocumentSummarizerServiceDto {
  // TODO: add creation fields
  [key: string]: unknown;
}

export interface UpdateDocumentSummarizerServiceDto {
  // TODO: add update fields
  [key: string]: unknown;
}

export class DocumentSummarizerServiceService {
  private readonly log = logger.child({ service: 'DocumentSummarizerServiceService' });
  ...
  async create(dto: CreateDocumentSummarizerServiceDto): Promise<Ai> {
    this.log.info({ dto }, 'create');
    return prisma.ai.create({ data: dto as never });
  }

  async update(id: ID, dto: UpdateDocumentSummarizerServiceDto): Promise<Ai> {
...
export const documentSummarizerServiceService = new DocumentSummarizerServiceService();
