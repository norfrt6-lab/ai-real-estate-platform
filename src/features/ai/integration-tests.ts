 ...
 * @branch  feat/ai-integration-tests
 */
...
describe('IntegrationTests - integration-tests', () => {
  ...
  describe('findById', () => {
    it('returns the record when it exists', async () => {
      ...
      (prisma.ai.findUnique as jest.Mock).mockResolvedValue(mockIntegrationTests);
  ...
  describe('create', () => {
    it('creates a new record with valid input', async () => {
      // Arrange
      const { prisma } = await import('@/lib/prisma');
      (prisma.ai.create as jest.Mock).mockResolvedValue(mockIntegrationTests);
  ...
  describe('delete', () => {
    it('deletes an existing record', async () => {
      const { prisma } = await import('@/lib/prisma');
      (prisma.ai.findUnique as jest.Mock).mockResolvedValue(mockIntegrationTests);
      (prisma.ai.delete as jest.Mock).mockResolvedValue(mockIntegrationTests);
